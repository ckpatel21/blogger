...
#SECRET_KEY = 'c2$gq(p(_3iigc@q5pmzfws@7nsmw5*a=_q)ncrw!z_fz79sp5'
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'c2$gq(p(_3iigc@q5pmzfws@7nsmw5*a=_q)ncrw!z_fz79sp5')
